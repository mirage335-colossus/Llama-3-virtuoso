...
# TODO: Foundational - attempt to call a model (eg. Llama-3_3-Nemotron-Super-49B-v1 ) using backends (local, remote, etc) according to rules from environment variables (presumably from '.env') .
