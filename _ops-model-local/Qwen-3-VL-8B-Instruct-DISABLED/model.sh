...
_model-Qwen-3-VL-8B-Instruct() {
    ...
    if _if_cygwin
    then
        _messagePlain_nominal '(cygwin)' ollama pull adelnazmy2002/Qwen3-VL-8B-Instruct
        ...
        [[ -e "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/latest ]] && current_origModelInstalled='true' && echo current_origModelInstalled
        ...
        ollama ls adelnazmy2002/Qwen3-VL-8B-Instruct
        
        _messagePlain_probe 'while... ollama pull'
        local currentIteration=0
        #while ( [[ ! -e "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/latest ]] || [[ ! -e "$current_OLLAMA_MODELS"/get_qwen3vlinstruct ]] ) && ( ! env OLLAMA_MODELS="$current_OLLAMA_MODELS_msw" ollama pull adelnazmy2002/Qwen3-VL-8B-Instruct || ! env OLLAMA_MODELS="$current_OLLAMA_MODELS_msw" ollama ls | grep -i 'adelnazmy2002/Qwen3-VL-8B-Instruct' )
        while ( [[ ! -e "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/latest ]] || [[ ! -e "$current_user_OLLAMA_MODELS"/get_qwen3vlinstruct ]] ) && ( ! ollama pull adelnazmy2002/Qwen3-VL-8B-Instruct || ! ollama ls | grep -i 'adelnazmy2002/Qwen3-VL-8B-Instruct' )
        do
            ...
            then
                _messagePlain_bad 'bad: ''ollama pull adelnazmy2002/Qwen3-VL-8B-Instruct'
                _messageFAIL
                #return 1
            fi
        ...
        [[ -e "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/latest ]] && mkdir -p "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct && rsync --size-only -r -v "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/. "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/.
        [[ ! -e "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/latest ]] && _messageFAIL

        local currentBlobHash
        grep -aoE 'sha256:[0-9a-f]{64}' "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/latest | tr ':' '-' | while IFS= read -r currentBlobHash; do
        ...
        ! ollama ls | grep -i 'adelnazmy2002/Qwen3-VL-8B-Instruct' && _messageFAIL
    fi
    ...
    if ! _if_cygwin
    then
        _messagePlain_nominal ollama pull adelnazmy2002/Qwen3-VL-8B-Instruct
        ...
        _messagePlain_probe 'while... ollama pull'
        local currentIteration=0
        #while ( [[ ! -e "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/latest ]] || [[ ! -e "$current_OLLAMA_MODELS"/get_qwen3vlinstruct ]] ) && ( ! env OLLAMA_MODELS="$current_OLLAMA_MODELS" ollama pull adelnazmy2002/Qwen3-VL-8B-Instruct || ! env OLLAMA_MODELS="$current_OLLAMA_MODELS" ollama ls | grep -i 'adelnazmy2002/Qwen3-VL-8B-Instruct' )
        while ( [[ ! -e "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/adelnazmy2002/Qwen3-VL-8B-Instruct/latest ]] || [[ ! -e "$current_user_OLLAMA_MODELS"/get_qwen3vlinstruct ]] ) && ( ! ollama pull adelnazmy2002/Qwen3-VL-8B-Instruct || ! ollama ls | grep -i 'adelnazmy2002/Qwen3-VL-8B-Instruct' )
        do
            _messagePlain_probe 'iteration'
            (( currentIteration++ ))
    ...
    (
        ...
        ollama create Qwen-3-VL-8B-Instruct-virtuoso -f Modelfile && echo > "$current_user_OLLAMA_MODELS"/get_qwen3vlinstruct
    )
