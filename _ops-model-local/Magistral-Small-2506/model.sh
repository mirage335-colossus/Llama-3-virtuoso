...
_model-Magistral-Small-2506() {
    ...
    local current_fileDir='Magistral-Small-2506'
    ...
    local current_file='Magistral-Small-2506-UD-IQ3_XXS.gguf'
    local current_URL='https://huggingface.co/unsloth/Magistral-Small-2506-GGUF/resolve/main/Magistral-Small-2506-UD-IQ3_XXS.gguf'
    local current_sha256='f5c7107b7cd5e9eb608968771e45b19b402808e27f217df4d0c6c79f9e27cb8e'
    local current_fileDir='Magistral-Small-2506'
    ...
    local current_URL='https://huggingface.co/unsloth/Magistral-Small-2506-GGUF/resolve/main/mmproj-F16.gguf'
    ...
    local current_URL='https://huggingface.co/unsloth/Magistral-Small-2506-GGUF/resolve/main/mmproj-F32.gguf'
...
_experiment-Magistral-Small-2506() {
    _stopwatch curl -X POST http://localhost:11434/api/chat \
    -H "Content-Type: application/json" \
    -d '{
        "model": "Magistral-Small-2506-virtuoso",
        "messages": [
