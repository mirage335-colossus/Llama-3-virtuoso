...
_model-Llama-3_3-Valkyrie-49B-v2() {
    ...
    local current_file='TheDrummer_Valkyrie-49B-v2-IQ2_XXS.gguf'
    local current_URL='https://huggingface.co/bartowski/TheDrummer_Valkyrie-49B-v2-GGUF/resolve/main/TheDrummer_Valkyrie-49B-v2-IQ2_XXS.gguf'
    local current_sha256='170e89ce1be87281fec42d6efdba92774bd64398524cdcb06ab636e68984a2aa'
    local current_fileDir='Llama-3_3-Valkyrie-49B-v2'
...
' >> "$scriptBundle"/ai_models/"$current_fileDir"/Modelfile
    ...
    (
        ...
        dos2unix Modelfile
        ollama create Llama-3_3-Valkyrie-49B-v2-virtuoso -f Modelfile
    )
    
}


_experiment-LLlama-3_3-Valkyrie-49B-v2() {
    _stopwatch curl -X POST http://localhost:11434/api/chat \
    -H "Content-Type: application/json" \
    -d '{
        "model": "Llama-3_3-Valkyrie-49B-v2-virtuoso",
        "messages": [
