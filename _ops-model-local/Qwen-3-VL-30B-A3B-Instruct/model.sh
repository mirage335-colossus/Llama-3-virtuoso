...
# Benchmarks suggest the 30B Mixture-of-Experts (MoE) model may be less accurate (ie. worse) than much smaller models, but the MoE model may or may not have some extra knowledge, etc, not well tested by the benchmarks.
...
_model-Qwen-3-VL-30B-A3B-Instruct() {
    ...
    local current_fileDir='Qwen-3-VL-30B-A3B-Instruct'
    ...
    if _if_cygwin
    then
        _messagePlain_nominal '(cygwin)' ollama pull qwen3-vl:30b-a3b-instruct-q4_K_M
        ...
        [[ -e "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/30b-a3b-instruct-q4_K_M ]] && current_origModelInstalled='true' && echo current_origModelInstalled
        ...
        ollama ls qwen3-vl:30b-a3b-instruct-q4_K_M
        
        _messagePlain_probe 'while... ollama pull'
        local currentIteration=0
        #while ( [[ ! -e "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/30b-a3b-instruct-q4_K_M ]] || [[ ! -e "$current_OLLAMA_MODELS"/get_qwen3vl30binstruct ]] ) && ( ! env OLLAMA_MODELS="$current_OLLAMA_MODELS_msw" ollama pull qwen3-vl:30b-a3b-instruct-q4_K_M || ! env OLLAMA_MODELS="$current_OLLAMA_MODELS_msw" ollama ls | grep -i 'qwen3-vl:30b-a3b-instruct-q4_K_M' )
        while ( [[ ! -e "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/30b-a3b-instruct-q4_K_M ]] || [[ ! -e "$current_user_OLLAMA_MODELS"/get_qwen3vl30binstruct ]] ) && ( ! ollama pull qwen3-vl:30b-a3b-instruct-q4_K_M || ! ollama ls | grep -i 'qwen3-vl:30b-a3b-instruct-q4_K_M' )
        do
            ...
            then
                _messagePlain_bad 'bad: ''ollama pull qwen3-vl:30b-a3b-instruct-q4_K_M'
                _messageFAIL
                #return 1
            fi
        ...
        [[ -e "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/30b-a3b-instruct-q4_K_M ]] && mkdir -p "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl && rsync --size-only -r -v "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/. "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/.
        [[ ! -e "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/30b-a3b-instruct-q4_K_M ]] && _messageFAIL

        local currentBlobHash
        grep -aoE 'sha256:[0-9a-f]{64}' "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/30b-a3b-instruct-q4_K_M | tr ':' '-' | while IFS= read -r currentBlobHash; do
        ...
        ! ollama ls | grep -i 'qwen3-vl:30b-a3b-instruct-q4_K_M' && _messageFAIL
    fi
    ...
    if ! _if_cygwin
    then
        _messagePlain_nominal ollama pull qwen3-vl:30b-a3b-instruct-q4_K_M
        ...
        _messagePlain_probe 'while... ollama pull'
        local currentIteration=0
        #while ( [[ ! -e "$current_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/30b-a3b-instruct-q4_K_M ]] || [[ ! -e "$current_OLLAMA_MODELS"/get_qwen3vl30binstruct ]] ) && ( ! env OLLAMA_MODELS="$current_OLLAMA_MODELS" ollama pull qwen3-vl:30b-a3b-instruct-q4_K_M || ! env OLLAMA_MODELS="$current_OLLAMA_MODELS" ollama ls | grep -i 'qwen3-vl:30b-a3b-instruct-q4_K_M' )
        while ( [[ ! -e "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/30b-a3b-instruct-q4_K_M ]] || [[ ! -e "$current_user_OLLAMA_MODELS"/get_qwen3vl30binstruct ]] ) && ( ! ollama pull qwen3-vl:30b-a3b-instruct-q4_K_M || ! ollama ls | grep -i 'qwen3-vl:30b-a3b-instruct-q4_K_M' )
        do
            _messagePlain_probe 'iteration'
            (( currentIteration++ ))
    ...
    _messagePlain_nominal 'ollama create Qwen-3-VL-30B-A3B-Instruct-virtuoso'
    ...
    (
        ...
        ollama create Qwen-3-VL-30B-A3B-Instruct-virtuoso -f Modelfile && echo > "$current_user_OLLAMA_MODELS"/get_qwen3vl30binstruct
    )


    [[ "$current_origModelInstalled" != "true" ]] && ollama rm qwen3-vl:30b-a3b-instruct-q4_K_M
    #rm -f "$current_user_OLLAMA_MODELS"/manifests/registry.ollama.ai/library/qwen3-vl/30b-a3b-instruct-q4_K_M

    true
}


_experiment-Qwen-3-VL-30B-A3B-Instruct() {
    _stopwatch curl -X POST http://localhost:11434/api/chat \
    -H "Content-Type: application/json" \
    -d '{
        "model": "Qwen-3-VL-30B-A3B-Instruct-virtuoso",
        "messages": [
